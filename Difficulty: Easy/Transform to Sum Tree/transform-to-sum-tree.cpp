...
class Solution {
  public:
    // Helper function to recursively convert the tree
    int convertToSumTree(Node* node) {
        ...
        // Store the current node's data (for returning the sum)
        int oldValue = node->data;

        // Update the current node's data to the sum of the left and right subtrees
    ...
    // Wrapper function to convert the tree
